    ...
    return (
        <label className={styles.label}>
            ...
            <span className={styles.check__box}>
                {isChecked ? (
                    <svg width="24px" height="24px" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.svgIcon}>
                    ...
                    <svg width="20px" height="20px" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.svgIcon}>
